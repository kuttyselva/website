...
<div class="w3-main" style="margin-left:300px">
 ...
 <section class="timeline">
  <ul>
    <li>
      <div>
        <time>2nd FEB 2018</time>
        Test in internet protocol , wireless network
      </div>
    </li>
    <li>
      <div>
        <time>7th FEB 2018</time> Last date to Submit Assignment.
      </div>
    </li>
    <li>
...
<div class="w3-third" id="mubtn">
  <div class="w3-card w3-container" style="min-height:460px;background-color: white; border: 5px solid black;">
     <h3><b>UNIT I</b></h3><br>
  <a href="https://www.mediafire.com/?t632cx9icbvnbr2"><i class="fas fa-file-pdf w3-margin-bottom w3-text-red" style="font-size:180px"></i></a>
...
<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px;background-color: white; border: 5px solid black;">
     <h3><b>UNIT II</b></h3><br>
  <a href="https://www.mediafire.com/?t632cx9icbvnbr2"><i class="fas fa-file-pdf w3-margin-bottom w3-text-blue" style="font-size:180px"></i></a>
...
<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px;background-color: white; border: 5px solid black;">
     <h3><b>UNIT III</b></h3><br>
  <a href="https://www.mediafire.com/?t632cx9icbvnbr2"><i class="fas fa-file-pdf w3-margin-bottom w3-text-green" style="font-size:180px"></i></a>
...
<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px;background-color: white; border: 5px solid black;">
     <h3><b>UNIT IV</b></h3><br>
  <a href="https://www.mediafire.com/?t632cx9icbvnbr2"><i class="fas fa-file-pdf w3-margin-bottom w3-text-orange" style="font-size:180px"></i></a>
...
<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px;background-color: white; border: 5px solid black;">
     <h3><b>UNIT V</b></h3><br>
  <a href="https://www.mediafire.com/?t632cx9icbvnbr2"><i class="fas fa-file-pdf w3-margin-bottom w3-text-pink" style="font-size:180px"></i></a>
...
<div class="w3-third">
  ...
  <a href="https://www.mediafire.com/?t632cx9icbvnbr2"><i class="fas fa-file-pdf w3-margin-bottom w3-text-yellow" style="font-size:180px"></i></a>

...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="portfolio">
    ...
    <div class="w3-container">
    <h1><b>Software Engineering</b></h1>
...
<div class="w3-third" id="mubtn">
  ...
  <h3><b>SOFTWARE PROCESS AND PROJECT MANAGEMENT</b></h3>
<p>Introduction to Software Engineering</p>
<p> Software Process, Perspective and Specialized Process
Models </p>
<p>Software Project Management: Estimation </p>
<p> LOC and FP Based Estimation, COCOMO Model  </p>
<p> Project Scheduling </p>
<p> Scheduling, Earned Value Analysis </p> 
  <p> Risk Management. </p>
...
<div class="w3-third">
  ...
  <h3><b>REQUIREMENTS ANALYSIS AND SPECIFICATION </b> </h3>
  <p>Software Requirements: Functional and Non-Functional, User requirements, System requirements,
Software Requirements Document </p> 
 <p>Requirement Engineering Process: Feasibility Studies,
Requirements elicitation and analysis, requirements validation, requirements management</p> 
 <p> Classical
analysis: Structured system Analysis, Petri Nets </p>
 <p>Data Dictionary. </p>
...
<div class="w3-third">
  ...
  <p> Architectural Design, Architectural Mapping using Data Flow</p>
  <p>User Interface
Design: Interface analysis, Interface Design </p>
  <p>Component level Design: Designing Class based
components, traditional Components.</p>
...
<div class="w3-third">
  <div class="w3-card w3-container" style="min-height:460px;background-color: white; border: 5px solid black;">
     ...
     <h3><b>TESTING AND IMPLEMENTATION </b></h3>
  <p>Software testing fundamentals</p>  
  <p>Internal and external views of Testing </p>
  <p>white box testing </p>
  <p> basis path testing </p>
  <p> control structure testing-black box testing</p> 
  <p>- Regression Testing </p>
  <p> Unit Testing – Integration
Testing – Validation Testing – System Testing And Debugging  </p>
  <p>QoS </p>
  <p>Software Implementation Techniques: Coding practices-Refactoring.</p>
  </div>
</div>
...
<form enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" <?php echo $flags;?>>
  ...
  <!-- Contact Section -->
  <div class="tabcon w3-container w3-padding-large "  id="grd">
